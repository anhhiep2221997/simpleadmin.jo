...
<body>
<h1>in ra 1 chuỗi ký tự nháy đơn ' hay nháy kép</h1>
<h1>In ra chuỗi 'Hà nội' thì nên dùng nháy kép bao nháy đơn</h1>
<?php echo "'chào hà nội'";?>
<h1>in ra chuối chào "hà nội" thì mình nên dùng nháy đơn bao nháy kép </h1>
<?php echo '"chào hà nội"';?>
<h1>tại sao pahir dùng quy tắc này</h1>
<div>bởi php nó cần phân biệt đâu là nháy để bao chuỗi và đâu là nháy cần xuất ra màn hình</div>
<h1>nháy bên ngoài cùng là nháy thật sự xuất hiện ra màn hình</h1>
<h1>nháy bên trong là nháy thật sự xuất ra màn hình</h1>
<h1>để php phân biệt chắc năng của 2 nháy.thì mình cần quy tắc </h1>
ol>
